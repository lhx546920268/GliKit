...
@interface GKKeyChainStore : NSObject
...
+ (GKKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (GKKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
@interface GKKeyChainStore (ErrorHandling)
...
@interface GKKeyChainStore (ForwardCompatibility)
...
@interface GKKeyChainStore (Deprecation)
