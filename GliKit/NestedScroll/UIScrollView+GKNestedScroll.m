...
///找到嵌套滑动容器
static UIScrollView* findNestedParentScrollView(UIView *child)
{
    ...
    if([scrollView isKindOfClass:UIScrollView.class] && scrollView.gkNestedParent){
        ...
        return findNestedParentScrollView(scrollView);
    }
}
...
- (UIScrollView *)gkNestedParentScrollView
{
    ...
    if(!scrollView){
        scrollView = findNestedParentScrollView(self);
