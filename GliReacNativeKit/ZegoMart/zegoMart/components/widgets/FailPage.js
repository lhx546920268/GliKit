...
import {load_fail} from '../../constraint/Image'
    ...
    render(){
        return (
            <View style={[this.props.style, {flex: 1, alignItems: 'center', justifyContent: 'center'}]}>
                ...
                <TouchableOpacity onPress={() => this.props.onReload()} style={{width: 100, height: 30, borderRadius: 15, borderWidth: 0.5, borderColor: '#cccccc', 
