...
if [ -d android/mobileRecharge ]
then
echo "android/mobileRecharge文件夹已存在"
else
mkdir android/mobileRecharge
fi
...
if [ -d ios/mobileRecharge ]
then
echo "ios/mobileRecharge文件夹已存在"
else
mkdir ios/mobileRecharge
fi

cd ../

rm -rf output/android/basic/*
rm -rf output/android/mobileRecharge/*
rm -rf output/ios/basic/*
rm -rf output/ios/mobileRecharge/*
...
echo "ios 基础打包完成"
react-native bundle --platform ios --dev false --entry-file mobileRecharge/index.js  --bundle-output output/ios/mobileRecharge/bundle.jsbundle --assets-dest output/ios/mobileRecharge/ --config business_config.js
echo "ios 业务打包完成"
...
react-native bundle --platform android --dev false --entry-file mobileRecharge/index.js --bundle-output output/android/mobileRecharge/bundle.jsbundle --assets-dest output/android/mobileRecharge/ --config business_config.js
echo "android 业务打包完成"

cd output/ios/mobileRecharge
