...
//加载更多状态
export const LOAD_MORE_STATUS_NORMAL = "normal"; //正常状态
export const LOAD_MORE_STATUS_LOADING = "loading"; //加载中
export const LOAD_MORE_STATUS_FAIL = "fail"; //加载失败
export const LOAD_MORE_STATUS_NO_MORE_DATA = "no_more_data"; //没有更多数据

//加载更多
export class LoadMoreControl extends Component{

    static defaultProps = {
        status: LOAD_MORE_STATUS_NO_MORE_DATA, //加载状态
    };
